...
namespace API.SignalR
{
   public class MessageHub : Hub
   {
      ...
      public MessageHub(IMessageRepository messageRepository, 
        IMapper mapper, IUserRepository userRepository, IHubContext<PresenceHub> presenseHub,
        PresenseTracker tracker)
      {
         _tracker = tracker;
      ...
      public async Task SendMessage(CreateMessageDto createMessageDto)
      {
         ...
         else
         {
            ...
            if (connections != null)
            {
               await _presenseHub.Clients.Clients(connections).SendAsync("NewMessageRecieved", 
